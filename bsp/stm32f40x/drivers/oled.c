...
#define OLED_I2CBUS_NAME  "i2c2"     /* I2CÉè±¸Ãû³Æ,±ØÐëºÍdrv_i2c.c×¢²áµÄI2CÉè±¸Ãû³ÆÒ»ÖÂ */

static struct rt_i2c_bus_device *oled_i2c_bus;    /* I2CÉè±¸¾ä±ú */		   

rt_err_t OLED_write_reg(rt_uint8_t reg, rt_uint8_t data)
{
    rt_uint8_t buf[2];
    ...
    if (rt_i2c_master_send(oled_i2c_bus, OLED_ADDR, 0, buf ,2) == 2)
    {
        return RT_EOK;
    }
    else
...
{
   OLED_write_reg(0x00, IIC_Command);
}
/**********************************************
// IIC Write Data
**********************************************/
